...
stored.atom = []
cmd.iterate_state(1, "4ug0_28S and name P", "stored.atom.append((resv, ID))")

outFile = open("4ug0_28S_distances.txt", 'w')

outFile.write("resi1(4ug0_28S)\tresi2(4ug0_28S)\tpdb_id_1\tpdb_id_2\tdistance\n")

for i,a1 in enumerate(stored.atom):
    a1_resv = a1[0]
    a1_ID = a1[1]

    for j,a2 in enumerate(stored.atom):
        a2_resv = a2[0]
        a2_ID = a2[1]
