...
def get_matrix(itx_file, n_bins, bin_size, genes,
               singleton, indirect, direct, regions, pairwise_file ):
    itx_fh=input_wrapper(itx_file)
    ...
    for line_num, line in enumerate(itx_fh):
        ...
        #Write a file for input to cooler.
...
def main():
    ...
    outfile = get_file_name(outfile)
    pairwise_name = outfile+'.pairwise.txt'
    pairwise_fh = open(pairwise_name, 'w')
